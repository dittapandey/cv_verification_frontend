  ...
  const [clubs, setClubs] = useState([
    {
      org_id: 100,
      name: "Coding Club",
      createdAt: "2022-02-05T10:05:45.000Z",
      updatedAt: "2022-02-05T10:05:45.000Z",
      parent_org_id: null,
    },
  ]);
    ...
    data.map((point) => {
      if (point.point_id != 107) {
        ...
        const sub_category_index =
          (_categoryData["categories"][category_index].hash[_category[1]] %
            10) -
          1;
        console.log(sub_category_index);
        _categoryData["categories"][category_index].sub_category[
          sub_category_index
        ]["data"].push(point);
      }
    });
        ...
        <Router>
          <Routes>
            <Route
              exact
              path="/"
              element={user ? <Link to="/headingPage" /> : <LoginPage />}
            />
